...
RenderPass::RenderPass(VkDevice logicalDevice, VkFormat swapchainImageFormat) {
  ...
  VkSubpassDescription sixthSubpass = {
    .flags = 0,
    .pipelineBindPoint = VK_PIPELINE_BIND_POINT_GRAPHICS,
    .inputAttachmentCount = 0,
    .pInputAttachments = NULL,
  ...
  std::vector<VkSubpassDescription> subpassList = {firstSubpass, secondSubpass, thirdSubpass, fourthSubpass, fifthSubpass, sixthSubpass};
  ...
  VkSubpassDependency sixthDependency = {
    .srcSubpass = 4,
    .dstSubpass = 5,
    .srcStageMask = VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT,
    .dstStageMask = VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT,
  ...
  std::vector<VkSubpassDependency> dependencyList = {firstDependency, secondDependency, thirdDependency, fourthDependency, fifthDependency, sixthDependency};
