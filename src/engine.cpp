...
Engine::Engine() {
  ...
  std::vector<std::string> modelFileNameList {"transparent.obj", "lens_2.obj", "film.obj", "aperture.obj", "lens_1.obj", "case.obj", "fish_eye_lens.obj", "participating_media.obj"};
