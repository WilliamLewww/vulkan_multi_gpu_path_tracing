...
void Device::createCommandBuffers(Scene* scene, VkPipelineLayout pipelineLayout, VkPipeline pipeline) {
  ...
  for (int x = 0; x < this->swapchainImageCount; x++) {
    ...
    vkCmdBindDescriptorSets(this->commandBufferList[x], VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout, 0, 1, &this->rayTraceDescriptorSet, 0, 0);    
    vkCmdBindDescriptorSets(this->commandBufferList[x], VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout, 1, 1, &this->materialDescriptorSet, 0, 0);
