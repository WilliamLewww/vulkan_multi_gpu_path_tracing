...
Textures::Textures(VkDevice logicalDevice, 
...

  {
    ImageFactory::createImage(logicalDevice,
                              ...
                              VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT, 
                              VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, 
                              &this->lensRayDirectionImage, 
                              &this->lensRayDirectionImageMemory);
    ...
    VkImageViewCreateInfo imageViewCreateInfo = {
      ...
      .pNext = NULL,
      .flags = 0,
      .image = this->lensRayDirectionImage,
      .viewType = VK_IMAGE_VIEW_TYPE_2D,
      .format = swapchainImageFormat,
      .components = {},
      .subresourceRange = subresourceRange,
    ...
    if (vkCreateImageView(logicalDevice, &imageViewCreateInfo, NULL, &this->lensRayDirectionImageView) != VK_SUCCESS) {
      printf("failed to create image view\n");
    }
  ...
  this->descriptorLensRayDirectionImageInfo = {
    .imageView = this->lensRayDirectionImageView,
    .imageLayout = VK_IMAGE_LAYOUT_GENERAL
  };
}
...
VkImage Textures::getLensRayDirectionImage() {
  return this->lensRayDirectionImage;
}

VkDescriptorImageInfo* Textures::getDescriptorLensRayDirectionImageInfoPointer() {
  return &this->descriptorLensRayDirectionImageInfo;
}