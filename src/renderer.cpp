  ...
  std::vector<std::vector<Descriptor*>> separatedDescriptorList = {
    {
      ...
      new Descriptor(8, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, (VkShaderStageFlagBits)(VK_SHADER_STAGE_FRAGMENT_BIT), this->displayDevice->getTextures()->getDescriptorLensRayDirectionImageInfoPointer(), NULL, NULL, NULL),
    },
    {
